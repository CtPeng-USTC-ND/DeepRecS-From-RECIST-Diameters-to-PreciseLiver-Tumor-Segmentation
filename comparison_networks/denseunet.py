...
def DenseUNet(input_shape, nb_dense_block=4, growth_rate=48, nb_filter=96, reduction=0.5,
    ...
    if K.image_dim_ordering() == 'tf':
      ...
      concat_axis = 1
      img_input = Input(shape=(2, 256, 256), name='data')
    ...
    x = Conv2D(2, (1,1), padding="same", kernel_initializer="normal", name="dense167classifer")(ac_up4)
